...
* `-r` (`--require_leg_types`): Specifies the required arbitrage pool types to require trades include. Possible values include: valence osmosis astroport. Multiple leg types may be required, separated by spaces.
